...
public class VertxProperties implements VertxConfigurer {
    ...
    private String verticleFactoryPrefix = "spring";
    ...
    public String getVerticleFactoryPrefix() {
        return verticleFactoryPrefix;
    }

    public void setVerticleFactoryPrefix(String verticleFactoryPrefix) {
