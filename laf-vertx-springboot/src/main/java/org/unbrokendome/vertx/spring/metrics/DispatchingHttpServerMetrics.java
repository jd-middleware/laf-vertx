...
public class DispatchingHttpServerMetrics extends AbstractDispatchingTcpMetrics<HttpServerMetrics>
    ...
    public Map<HttpServerMetrics, ?> responsePushed(Map<HttpServerMetrics, ?> socketMetric,
        ...
        return unmapWithResult(socketMetric, (m, c) -> m.responsePushed(c, method, uri, response));
    }
