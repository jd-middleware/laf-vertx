...
public class ChoosableIterableImpl<T> implements ChoosableIterable<T> {
    ...
    protected static final ChoosableIterable<Object> EMPTY = new ChoosableIterable<Object>() {
        @Override
    ...
    protected final AtomicReference<List<T>> itemsRef;
    protected AtomicInteger chooseCnt = new AtomicInteger();
